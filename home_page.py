...
st.markdown("**Pergunta 2: Como um modelo de classificação pode ser desenvolvido para identificar e atribuir uma música a um cluster específico, com base em seus atributos musicais presentes no dataset \"Spotify Tracks\"?**")
st.write("O objetivo desta pergunta é desenvolver e avaliar um modelo de classificação capaz de categorizar novas músicas e atribuí-las a um dos clusters previamente identificados, com base em seus atributos musicais. Essa classificação permitirá uma organização mais precisa do universo musical e servirá como base para futuros sistemas de recomendação que sugiram músicas dentro de clusters específicos de interesse do usuário.")
